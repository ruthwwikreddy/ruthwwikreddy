...
CRITICAL TEMPLATE & FORMAT REQUIREMENT:
Follow this exact visual and structural hierarchy:

<div align="center">

# ruthwwikreddy

**[One punchy, bold tagline explaining what the project is in clear technical terms.]**

[One concise paragraph explaining what problem it solves and how it works based strictly on the repository files.]
...
| Capability | Detail |
|---|---|
| [Feature 1] | [Fact-based detail derived from source code] |
| [Feature 2] | [Fact-based detail derived from source code] |
| [Feature 3] | [Fact-based detail derived from source code] |

## 2. Architecture

```
[Clean ASCII diagram showing components, inputs, outputs, or data flow]
```
...
## 4. Prerequisites
- [Runtime prerequisites like Node.js / Python / Browser]
...
cd ruthwwikreddy
[Accurate install and run commands based on actual files present]
```

## 6. Environment variables
[Table or code block showing required env vars with placeholders, or statement that none are required.]
...
## 8. Known Limitations
- [Factual limitations from the code]
